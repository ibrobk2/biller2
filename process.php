...
//Set sender email
	$mail->setFrom('abubakarbishir081@gmail.com',"KEDCO Katsina");
//Enable HTML
	$mail->isHTML(true);
//Attachment
...
if(isset($_POST['btn_add_admin'])){
    ...
    $sql = "INSERT INTO admin (fname, username, password) VALUES ('$fname', '$username', '$password')";
    $result = mysqli_query($conn, $sql);
    if($result){
        echo "
            <script>
...
$mail->Subject = $subject;
//Set sender email
$mail->setFrom('abubakarbishir081@gmail.com', "KEDCO  Management");
//Enable HTML
$mail->isHTML(true);
//Attachment
// $mail->addAttachment('img/attachment.png');
